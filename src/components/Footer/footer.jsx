...
export default function Footer() {
  return (
    <Fragment>
            <footer style={{ display: 'flex', justifyContent: 'center',width:"1500px"}}className="site-footer">
                <div style={{ display: 'flex', justifyContent: 'center',width:"1500px"}}  className="container">
                    <div  style={{ display: 'flex', justifyContent: 'center',width:"1500px"}} className="footer-top">
                        <div className="footer-top-left">
                            <ul>
                                <li className="footer-top-left__heading"><a href="">Khám phá dịch vụ</a></li>
                                <li><a href="">Khám tổng quát sức khỏe</a></li>
                                <li><a href="">Khám chuyên khoa nội</a></li>
                                <li><a href="">Khám ngoại khoa </a></li>
                                <li><a href="">Khám sản phụ khoa</a></li>
                                <li><a href="">Khám tai mũi họng</a></li>
                                <li><a href="">Khám răng hàm mặt</a></li>
                                <li><a href="">Khám mắt</a></li>
                                <li><a href="">Khám da liễu</a></li>
                                <li><a href="">Tiêm phòng và tư vấn sức khỏe</a></li>
                            </ul>
                            <ul>
                                <li className="footer-top-left__heading"><a  href="">Dịch vụ khách hàng</a></li>
                                <li><a href="">Hỏi đáp - FAQs</a></li>
                                <li><a href="">Chính sách hỗ trợ tốt</a></li>
                                <li><a href="">Liên hệ</a></li>
                                <li><a href="">Dịch vụ của chúng tôi</a></li>
                                <li><a href="">Thành viên ĐKPN</a></li>
                                <li><a href="">Khách hàng hài lòng 100%</a></li>
                                <li><a href="">Chính sách khuyến mãi</a></li>
                                <li><a href="">Chính sách giao hàng</a></li>
                                <li><a href="">Chính sách bảo mật</a></li>
                                <li><a href="">Chính sách bảo mật thanh toán</a></li>
                                <li className="footer-top-left__heading mg-top30"><a href="">Kiến thức sống khỏe</a></li>
                                <li><a href="">Hướng dẫn thói quen sinh hoạt tốt</a></li>
                                <li ><a href="">Blog</a></li>
                                <li ><a href="">Group trao đổi cải thiện sức khỏe</a></li>
                            </ul>
                            <ul>
                                <li className="footer-top-left__heading" ><a href="">Tài liệu - Tuyển dụng</a></li>
                                <li><a href="">Đăng ký bản quyền</a></li>
                                <li><a href="">Tuyển dụng</a></li>
                                <li className="footer-top-left__heading mg-top30"><a href="">Về phòng khám ĐKPN</a></li>
                                <li><a href="">Câu chuyện về phòng khám</a></li>
                                <li><a href="">Gia nhập ĐKPN</a></li>
                                <li><a href="">Care & Share</a></li>
                                <li><a href="">Nơi làm việc</a></li>
                            </ul>
                            <ul>
                        ...
                        <div className="footer-top-right">
                            <h3 className="footer-top-right__heading">Đa khoa Phố Nối lắng nghe bạn!</h3>
